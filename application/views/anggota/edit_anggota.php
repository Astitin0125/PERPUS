...
<div class="col-md-12">
          <div class="box box-info">
            ...
            <form method="post" action="<?= base_url()?>anggota/edit" class="form-horizontal">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nis" value="<?= $data['id_anggota'];?> class="form-control" placeholder="Nis">
                  </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="email" value="<?= $data['id_anggota'];?> class="form-control" placeholder="Email">
                  </div>
                </div>
